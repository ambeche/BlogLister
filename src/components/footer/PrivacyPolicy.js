...
const PrivacyPolicy = () => {
  return (
    <Container>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Bloglister.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Bloglister, accessible from{' '}
            <a
              href="https://bloglister-2.herokuapp.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://bloglister-2.herokuapp.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: tamanji.che@metropolia.fi</li>
      </ul>
    </Container>
  );
};
